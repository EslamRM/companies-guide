<template>
  ...
  >
    ...
    <div class="w-full md:w-1/3 text-left leading-8">
      <h1
      ...
      >
        Azizi Real Estate Company
      </h1>
      <p
        class="font-general-medium mt-3 text-lg sm:text-xl  xl:text-xl text-center sm:text-left leading-none text-gray-400"
      >
        All You Want To Know About Our Companies is Here
      </p>
    ...
    <div class="w-full md:w-2/3 text-right float-right">
      <img
        v-if="theme === 'light'"
        src="../../assets/images/banner-light.jpg"
        alt="Developer"
      />
      <img
        v-else
        src="../../assets/images/banner-dark.jpg"
        alt="Developer"
      />
    </div>
  </section>
